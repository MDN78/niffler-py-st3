...
class TestAuthentication:
    ...
    def test_playwright_registration_new_user(self, login_page, envs):
    ...
    @Pages.open_login_page
    def test_playwright_authentication_user(self, login_page, envs):
    ...
    @Pages.open_login_page
    def test_playwright_login_user_with_invalid_login_or_password(self, login_page, envs):
        login_page.login('username', 'password')
        login_page.text_unsuccessful_login("Неверные учетные данные пользователя")

    @Pages.open_login_page
    def test_playwright_registration_new_user_with_forbidden_name(self, login_page, envs):
